    ...
    <div class="row">
        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
            <div class="btn-group me-2" role="group" aria-label="Second group">
                <a href="/projects/new" alt="Добавить" type="button" class="btn add">
            ...
            <c:forEach var="project" items="${projects}">
                <tr>
                    ...
                    <td>
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group me-2" role="group" aria-label="Second group">
                                <a href="/projects/<c:out value = '${project.id}'/>" alt="Редактировать" type="button" class="btn edit_btn">
                                  ...
                                  <a href="/projects?deleteId=<c:out value = '${project.id}'/>" alt="Удалить" type="button" class="btn del_btn">
