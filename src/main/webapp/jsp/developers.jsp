    ...
    <div class="row">
        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
            <div class="btn-group me-2" role="group" aria-label="Second group">
                <a href="/developers/new" alt="Добавить" type="button" class="btn add">
        ...
        <table class="table">
            ...
            <c:forEach var="developer" items="${developers}">
                <tr>
                    ...
                    <td><c:out value = "${developer.developerAge}"/></td>
                    <td><c:out value = "${developer.dateOfBirth}"/></td>
                    <td><c:out value = "${developer.gender}"/></td>
                    <td><b><a class="rd_link" href="/companies/${developer.companyId}">${developer.companyId}</b></a></td>
                    <td><c:out value = "${developer.salary}"/></td>
                    <td>
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group me-2" role="group" aria-label="Second group">
                                <a href="/developers/<c:out value = '${developer.id}'/>" alt="Редактировать" type="button" class="btn edit_btn">
                                  ...
                                  <a href="/developers?deleteId=<c:out value = '${developer.id}'/>" alt="Удалить" type="button" class="btn del_btn">
