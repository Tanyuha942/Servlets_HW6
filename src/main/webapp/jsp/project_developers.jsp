...
<% java.util.List<com.goit.model.Developer> listProjectDevelopers = (java.util.List<com.goit.model.Developer>) request.getAttribute("listProjectDevelopers"); %>
<% java.lang.String projectName = (java.lang.String) request.getAttribute("projectName"); %>
    ...
    <div class="row">
        <table class="table">
          ...
          <c:forEach var="element" items="${listProjectDevelopers}">
            <c:forEach var="p" items="${projectName}">
                <tr>
                    <td><c:out value = "${p}"/></td>
