...
import com.goit.exceptions.SqlReturnedItemException;
...
public class DbHelper {
    ...
    public static Optional<Long> executePreparedStatementAndGetId(String sql, ParameterSetter psCall)
        throws SqlReturnedItemException {
        try (Connection connection = DataSourceHolder.getDataSource().getConnection();
            PreparedStatement ps = connection.prepareStatement(sql)) {
            psCall.set(ps);
            ps.execute();
